;;; ox-slimhtml-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ox-slimhtml" '("ox-slimhtml-")))

;;;***

;;;### (autoloads nil nil ("ox-slimhtml-pkg.el") (0 0 0 0))
