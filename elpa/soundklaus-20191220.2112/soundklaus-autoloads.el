...
List activities on SoundCloud." t nil)

(autoload 'soundklaus-connect "soundklaus" "\
Connect with SoundCloud." t nil)
...
List your playlists on SoundCloud." t nil)

(autoload 'soundklaus-my-favorites "soundklaus" "\
List your favorite tracks on SoundCloud." t nil)

(autoload 'soundklaus-my-tracks "soundklaus" "\
List your tracks on SoundCloud." t nil)

(autoload 'soundklaus-desktop-entry-save "soundklaus" "\
Install the SoundKlaus desktop entry for the X Window System." t nil)
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "soundklaus-playlist" '("playlist" "soundklaus-")))
