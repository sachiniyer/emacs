...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ibuffer-project" '("project-" "ibuffer-project-")))

;;;***

;;;### (autoloads nil nil ("ibuffer-project-pkg.el") (0 0 0 0))
