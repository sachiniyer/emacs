...
;;;***

;;;### (autoloads nil "org-starter-utils" "org-starter-utils.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from org-starter-utils.el

(autoload 'org-starter-utils-avy-id "org-starter-utils" "\
Retrieve the ID to an entry selected with avy.

\(fn)" nil nil)

(autoload 'org-starter-utils-avy-custom-id "org-starter-utils" "\
...
(autoload 'org-starter-utils-avy-store-link-to-heading "org-starter-utils" "\
