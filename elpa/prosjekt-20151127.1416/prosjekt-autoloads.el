...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "async-shell-command-prosjekt" '("prosjekt-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "prosjekt" '("prosjekt-" "defun-autosave")))
