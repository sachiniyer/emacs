;;; playerctl-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(autoload 'playerctl-metadata "playerctl" "\
Get metadata from playerctl player." t nil)

(register-definition-prefixes "playerctl" '("playerctl-"))
