...
With prefix ARG, enable Global Ace-Isearch mode if ARG is positive; otherwise,
disable it.
...
Ace-Isearch mode is enabled in all buffers where `ace-isearch--turn-on' would do
it.
