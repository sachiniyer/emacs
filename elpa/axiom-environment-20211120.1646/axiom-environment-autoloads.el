;;; axiom-environment-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "axiom-base" '("axiom-"))
...
(register-definition-prefixes "axiom-boot-mode" '("axiom-boot-"))
...
Display a list of Axiom buffers." t nil)

(register-definition-prefixes "axiom-buffer-menu" '("axiom-buffer-menu-"))
...
(register-definition-prefixes "axiom-help-mode" '("axiom-help-"))
...
(register-definition-prefixes "axiom-input-mode" '("axiom-input-"))
...
(autoload 'axiom-process-start-hyperdoc "axiom-process-mode" "\
Start the HyperDoc GUI from within FriCAS." t nil)
...
(register-definition-prefixes "axiom-process-mode" '("axiom-process-" "with-axiom-process-query-buffer"))
...
(register-definition-prefixes "axiom-selector" '("??" "?a" "?b" "?i" "?q" "?r" "?s" "axiom-" "define-axiom-selector-function"))
...
(register-definition-prefixes "axiom-spad-mode" '("axiom-spad-"))
