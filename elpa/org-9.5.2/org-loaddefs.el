...
`Org-List-Checkbox-Radio mode' mode.  If the prefix argument is positive, enable
...
This is a minor mode.  If called interactively, toggle the `Org-Num mode' mode.
...
This is a minor mode.  If called interactively, toggle the
`Org-Table-Header-Line mode' mode.  If the prefix argument is positive, enable
the mode, and if it is zero or negative, disable the mode.
...
This is a minor mode.  If called interactively, toggle the `OrgTbl mode' mode.
If the prefix argument is positive, enable the mode, and if it is zero or
negative, disable the mode.
...
This is a minor mode.  If called interactively, toggle the `Org-Beamer mode'
mode.  If the prefix argument is positive, enable the mode, and if it is zero or
negative, disable the mode.
