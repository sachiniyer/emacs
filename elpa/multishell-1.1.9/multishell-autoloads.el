...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "multishell" '("multishell-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "multishell-list" '("multishell-list-")))
