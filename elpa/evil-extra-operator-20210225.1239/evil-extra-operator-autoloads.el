...
If called interactively, enable Evil-Extra-Operator mode if ARG
...
(autoload 'evil-extra-operator-mode-install "evil-extra-operator" nil nil nil)

(put 'global-evil-extra-operator-mode 'globalized-minor-mode t)
