...
\(fn PREFIX &key (AUTO-FOLLOW t))" t nil)

(autoload 'axe-logs-describe-log-streams "axe-logs" "\
...
\(fn LOG-GROUP-NAME &key AUTO-FOLLOW (AUTO-FOLLOW-DELAY 30.0))" t nil)
...
(autoload 'axe-logs-log-stream-near-point "axe-logs" "\
Open the log stream defined near the current point.
...
(autoload 'axe-logs-log-streams-near-point "axe-logs" "\
