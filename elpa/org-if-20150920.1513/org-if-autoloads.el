...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ob-org-if" '("org-babel-default-header-args:org-if")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-if-active" '("org-if-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-if-interpreter" '("org-if-" "*org-if-funcs*")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-if-link" '("org-if-open")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-if-misc" '("org-if-" "*org-if-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-if-reader" '("org-if-" "*org-if-")))
