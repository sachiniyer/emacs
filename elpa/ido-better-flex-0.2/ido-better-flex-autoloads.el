...

;;;### (autoloads nil "ido-better-flex" "ido-better-flex.el" (0 0
;;;;;;  0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ido-better-flex" '("ido-better-flex/")))
